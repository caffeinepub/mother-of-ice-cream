import { c as createLucideIcon, u as useFeaturedFlavors, j as jsxRuntimeExports, m as motion, B as Button, L as Link, r as reactExports, M as MapPin, T as Truck } from "./index-ebqjeJ_x.js";
import { F as FlavorCard } from "./FlavorCard-CCNeOR1v.js";
import { S as Skeleton } from "./skeleton-CdAKPTdi.js";
...
function PartyOrderBanner() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      style: {
        background: "linear-gradient(90deg, oklch(0.58 0.24 20) 0%, oklch(0.65 0.22 355) 40%, oklch(0.72 0.20 45) 100%)"
      },
      "data-ocid": "home.section",
      children: [
        "🎉 We are currently only taking",
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "underline underline-offset-2", children: "PARTY ORDERS" }),
...
function VideoSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      style: {
        background: "linear-gradient(160deg, oklch(0.13 0.025 270), oklch(0.10 0.04 300), oklch(0.13 0.025 270))"
      },
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              background: "radial-gradient(ellipse at 20% 50%, oklch(0.64 0.22 355 / 0.12), transparent 55%), radial-gradient(ellipse at 80% 50%, oklch(0.82 0.13 185 / 0.1), transparent 55%)"
            }
          }
        ),
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
                    ...
                    children: "🎬 Behind the Scoop"
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-4xl lg:text-5xl font-black text-white leading-tight mb-4", children: [
                  "Watch Us Create",
                  " ",
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
                      style: {
                        background: "linear-gradient(135deg, oklch(0.64 0.22 355), oklch(0.88 0.16 85))",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/50 text-lg max-w-xl mx-auto", children: "From our kitchen to your hands — pure handcrafted goodness in every scoop." })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative rounded-3xl overflow-hidden shadow-2xl border border-white/10", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "video",
                    {
                      ref: videoRef,
                    ...
                    "div",
                    {
                      ...
                      children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                          ...
                          children: /* @__PURE__ */ jsxRuntimeExports.jsx(Play, { className: "w-8 h-8 text-white fill-white ml-1" })
                        }
                      )
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-black/0 group-hover:bg-black/10 transition-colors duration-300" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      ...
                      children: isPlaying ? "Tap to pause" : "Tap to play"
                    }
                  )
                ] })
              ]
...
function ShopShowcaseSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "py-20 bg-white relative overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className: "absolute inset-0 pointer-events-none",
        style: {
          background: "radial-gradient(ellipse at 80% 50%, oklch(0.97 0.03 15 / 0.6), transparent 60%)"
        }
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-6xl mx-auto px-6 relative z-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-12 items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative rounded-3xl overflow-hidden shadow-2xl border-4 border-white", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "img",
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  style: {
                    background: "linear-gradient(135deg, oklch(0.64 0.22 355), oklch(0.72 0.20 45))"
                  },
                  children: "🏆 Kolkata's Favourite"
                }
              )
            ] })
          ]
        ...
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-4xl lg:text-5xl font-black text-foreground leading-tight", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                    ...
                    children: "Mother of Ice-cream"
                  }
                )
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-lg leading-relaxed", children: "Nestled in the heart of Kolkata, our shop is a joyful celebration of flavour, colour, and happiness. Every scoop is made fresh daily with the finest local ingredients — because you deserve nothing less than the best." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-3", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground font-semibold", children: item.text })
            ] }, item.text)) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-muted-foreground text-sm font-semibold", children: [
...
function HomePage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(PartyOrderBanner, {}),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(ShopShowcaseSection, {}),
